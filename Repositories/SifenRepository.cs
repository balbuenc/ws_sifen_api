        ...
        public async Task<IEnumerable<Dte>> InsertDTE(Dte dte)
        {
            try
            {
                ...
                var result = await db.QueryAsync<Dte>(sql, new
                {
                    ...
                    dte.presencia,
                    dte.tipoPago,
                    dte.tp_Tc_Denominacion,
                    dte.tp_Tc_Forma_Procesamiento,
                    dte.tp_Ch_Numero,
                    dte.tp_Ch_Banco,
                    dte.nc_Motivo_Emision,
                    dte.nc_Tipo_Documento_Asociado,
                    dte.nc_CDC_Referencia,
                    dte.nc_Timbrado_Referencia,
                    dte.nc_Tipo_Documento_Impreso,
                    dte.nc_Fecha_Emision_Referencia,
